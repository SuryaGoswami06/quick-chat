...
function Home() {
 return (
    <div className='flex flex-col w-full h-full '>
        <div className='flex flex-col shadow-lg rounded-lg max-w-[1024px] w-full h-[96%] md:h-[620px] mx-auto'>
                <div className='h-[93%] overflow-y-auto'>
                     <Outlet />
                </div>
                <div className='border-t border-[#e2e8f0] flex items-center justify-center h-[7%]'>
                    <div className='flex' >
                        <NavLink to='/' className={({isActive})=>`flex justify-center items-center px-2 mr-1 cursor-pointer ${isActive?'border-b-2 border-[#1877f2]':''}`}>
                        ...
                        <NavLink to='create-a-room' className={({isActive})=>`flex justify-center items-center px-2  mr-1 cursor-pointer ${isActive?'border-b-2 border-[#1877f2]':''}`}>
                        ...
                        <NavLink to='chats' className={({isActive})=>`flex justify-center px-2 items-center cursor-pointer ${isActive?'border-b-2 border-[#1877f2]':''}`}>
